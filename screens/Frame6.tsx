...
import IntimateDecorationContainer from "../components/IntimateDecorationContainer";
...
`}</Text>
        ...
        <View style={[styles.component3, styles.component3Position]}>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/divscardicon3.png")}
          />
        </View>
      </View>
      <View
...
`}
      ...
      <View style={[styles.rectangleParent2, styles.groupChild13Border]}>
        <Image
          ...
          contentFit="cover"
          source={require("../assets/rectangle-1550.png")}
        />
