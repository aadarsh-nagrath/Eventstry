...
export type NonVegSectionType = {
  nonVegMenuItems?: string;

  /** Style props */
  chickenTandooriChickenMarginTop?: number | string;
};
...
const NonVegSection = ({
  nonVegMenuItems,
  chickenTandooriChickenMarginTop,
}: NonVegSectionType) => {
  const groupViewStyle = useMemo(() => {
    return {
      ...getStyleValue("marginTop", chickenTandooriChickenMarginTop),
    };
  }, [chickenTandooriChickenMarginTop]);
